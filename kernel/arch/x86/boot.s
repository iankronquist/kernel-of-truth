...
section .text
	...
	_start:
		...
		mov dword edi, pagetab + 0x40000000
	...
	add_ent:
		;  Only map the kernel. */
		cmp esi, (kernel_start + 0x40000000)
		jl cont
		cmp esi, (kernel_end + 0x40000000)
		jge break
	...
	break:
		...
		mov dword [pagetab + 0x40000000 + 1023*4], 0x000B8003
	...
	setup:
		...
		mov dword [pagedir + 0x40000000 + 0], (pagetab + 0x40000000 + 0x0003)
		mov dword [pagedir + 0x40000000 + 768*4], (pagetab + 0x40000000 + 0x0003)
		;  Set cr3 to the address of the pagedir */
		mov ecx, (pagedir + 0x40000000)
		mov cr3, ecx
...
section .bss
	...
	;  4 MiB for the kernel binary and initial data. */
